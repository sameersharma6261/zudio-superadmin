...
const BrandDashboard = () => {
  ...
  return (
    ...
    >
      <h1 style={{ color: "white", fontSize: "48px", fontFamily: "Rajdhani, sans-serif", position: "absolute", left: "20px", top: "10px", zIndex: "200" }}>
        zudio
      </h1>
      <input
        type="text"
...
>
  {filteredShops.map((shop) => (
    ...
    >
      ...
      >
        <h3 style={{ fontSize: "29px", margin: "0 0 5px,", fontFamily: "Rajdhani, sans-serif", }}>{shop.title}</h3>
        <p style={{ fontSize: "20px", opacity: 0.9, fontFamily: "Rajdhani, sans-serif", }}>{shop.description}</p>
      </div>
    </div>
  ))}
</div>
